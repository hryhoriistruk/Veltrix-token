...
contract GovernorAlpha {
    ...
    string public constant name = "Lokynex Governor Alpha";
    ...
    /// @notice The address of the Lokynex Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Lokynex governance token
