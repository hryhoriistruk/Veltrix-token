...
export async function buildGovernor(
  ...
  const fetchers = [
    ...
    >(
      ...
      * "Governor Deploy Alpha name:<String> timelock:<Address> comp:<Address> guardian:<Address>" - Deploys Lokynex Governor Alpha
    ...
    >(
      ...
      * "Governor Deploy AlphaHarness name:<String> timelock:<Address> comp:<Address> guardian:<Address>" - Deploys Lokynex Governor Alpha with a mocked voting period
